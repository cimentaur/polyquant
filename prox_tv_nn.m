function [sol, info] = prox_tv_nn(b, gamma, param)
...
%
%   * *param.up* : upper limit for box constraints (default: inf)
%
...
% Date: Jan 2013
% Modified: Jonathan H Mason, 2017
%          - included non-negativity and optional box constraint
%
...
if ~isfield(param, 'maxit'), param.maxit = 20; end
if ~isfield(param, 'weights'), param.weights = [1, 1]; end
if ~isfield(param, 'up'), param.up = inf; end
...
for iter = 1:param.maxit
    ...
    % Current solution
    sol = projC(b - gamma*div_op(r, s, wx, wy),param.up);
